...
TEST(NumberConstructor, Constructor) {
	Lab3::Number l1, l2("-a4b"), l3("523abf4"), l4(53109301);
	ASSERT_EQ(1, l1.getLength());
	ASSERT_EQ(3, l2.getLength());
	ASSERT_EQ(7, l3.getLength());
	ASSERT_EQ(7, l4.getLength());
	ASSERT_STREQ("00", l1.getArray());
	ASSERT_STREQ("1a4b", l2.getArray());
	ASSERT_STREQ("0523abf4", l3.getArray());
	ASSERT_STREQ("032a6235", l4.getArray());
}
