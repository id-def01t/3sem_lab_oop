...
namespace Lab3 {
	...
	private:
		...
		char *a;	// Массив длинной 31 символ и + знак
	public:
		// Конструкторы
		...
		// Копирующий конструктор (используется глубокое копирование)
		...
		// Перегруженный оператор присваивания компированием
